...
import { StyleSheet, Text, TextInput, View, Button, TouchableHighlight, Alert,SafeAreaView  } from 'react-native';
import Svg, { 
  Circle,
  G,
  Line,
...
import { GetHangmanQuestions } from '../../Extras/AllApis';
...
class GameScreen extends React.Component {
  ...
  GameApi(){
    ...
    .then((json)=>{
      ...
      if(Code == '00'){
        ...
        this.setState({gameHint:Data[this.state.index].Hint, gameAnswer:Data[this.state.index].Answer})
        // this.init();
  ...
  init(){
    ...
    let answer = this.state.gameAnswer.replace(/[^a-zA-Z]/gmi, " ").trim();
    ...
    this.setState({
      ...
      answer:this.state.gameAnswer,
      hint:this.state.gameHint,
      correct:0,
      wrong:0,
      usedLetters:[],
  ...
  render(){
    const {gameHint, gameAnswer } = this.state;
    let rope = <Line x1="250" y1 = "0" x2="250" y2 = "120" stroke="#895917" strokeWidth="5" id="rope"/>;
    let head = <Circle cx="250" cy="150" r="30" id="head" fill="#1e8449"/>;
    let bodyMain = <Rect width="10" height="100" x="245" y="150" id="bodyMain" fill="#1e8449"/>
    let hands = <G><Line x1="250" y1="200" x2="220" y2="230" stroke="#1e8449" stroke-Linecap="round" strokeWidth="10" id="handLeft" />
    <Line x1="250" y1="200" x2="280" y2="230" stroke="#1e8449" stroke-Linecap="round" strokeWidth="10" id="handRight"/></G>;
    let legs = <G><Line x1="250" y1="250" x2="230" y2="300" stroke="#1e8449" stroke-Linecap="round" strokeWidth="10" id="legLeft"/>
    <Line x1="250" y1="250" x2="270" y2="300" stroke="#1e8449" stroke-Linecap="round" strokeWidth="10" id="legRight"/></G>
    return(
      ...
      <View style={styles.container}>
        ...
        <Svg version="1.1" viewBox="0 0 500 500" preserveAspectRatio="xMinYMin meet" class="svg-content" width="200" height="200">
        ...
        {this.renderDashes()}
        <View style={styles.hintContainer}><Text style={styles.hintText}>Hint : {gameHint}</Text></View>
        {this.renderKeyBoard()}
      </View>
      :
